...
urlpatterns = [
    ...
    path('periodos/<int:pk>/revision/inconsistencias.xlsx',
         views_variance.periodo_revision_inconsistencias_excel,
         name='nominas_periodo_revision_inconsistencias_excel'),
