...
def _construir_steps(periodo, hoy):
    ...
    try:
        ...
        pass
    steps.append({
        'n': 1, 'icon': 'fas fa-clock', 'titulo': 'Asistencia del mes',
    ...
    try:
        ...
        pass
    steps.append({
        'n': 2, 'icon': 'fas fa-cogs', 'titulo': 'Conceptos sin inconsistencias',
    ...
    if periodo:
        steps.append({
            'n': 3, 'icon': 'fas fa-calendar-plus', 'titulo': 'Período abierto',
        ...
        steps.append({
            'n': 3, 'icon': 'fas fa-calendar-plus', 'titulo': 'Crear período del mes',
    ...
    if periodo:
        ...
        # Step 4: Generar
        steps.append({
            'n': 4, 'icon': 'fas fa-calculator', 'titulo': 'Generar planilla',
        ...
        # Step 5: Aprobar
        steps.append({
            'n': 5, 'icon': 'fas fa-check-circle', 'titulo': 'Aprobar planilla',
        ...
        steps.append({
            'n': 6, 'icon': 'fas fa-paper-plane', 'titulo': 'Emitir boletas',
        ...
        steps.append({
            'n': 7, 'icon': 'fas fa-signature', 'titulo': 'Acuses de recibo',
        ...
        steps.append({
            'n': 8, 'icon': 'fas fa-file-export', 'titulo': 'Exportar PLAME',
        ...
        # Step 9: Asiento contable
        steps.append({
            'n': 9, 'icon': 'fas fa-file-invoice', 'titulo': 'Asiento contable',
        ...
        # Step 10: Cerrar
        steps.append({
            'n': 10, 'icon': 'fas fa-lock', 'titulo': 'Cerrar período',
        ...
        for n, icon, titulo, descr in [
            (4, 'fas fa-calculator',       'Generar planilla',     'Espera al paso 3'),
            (5, 'fas fa-check-circle',     'Aprobar planilla',     'Espera al paso 3'),
            (6, 'fas fa-paper-plane',      'Emitir boletas',       'Espera al paso 3'),
            (7, 'fas fa-signature',        'Acuses de recibo',     'Espera al paso 3'),
            (8, 'fas fa-file-export',      'Exportar PLAME',       'Espera al paso 3'),
            (9, 'fas fa-file-invoice',     'Asiento contable',     'Espera al paso 3'),
            (10, 'fas fa-lock',            'Cerrar período',       'Espera al paso 3'),
        ]:
            steps.append({
                'n': n, 'icon': icon, 'titulo': titulo,
