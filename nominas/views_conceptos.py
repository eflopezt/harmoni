...
TEMPLATES_CONCEPTOS = {
    ...
    # ─── NUEVOS — Mayo 2026 ──────────────────────────────────────────
    'horas_extras_100': {
        'codigo': 'horas_extras_100', 'nombre': 'Horas extras 100% (domingo/feriado)',
        'descripcion': 'Trabajo en día de descanso semanal o feriado. Recargo 100% (Ley 27671). REMUNERATIVO.',
        'categoria': 'OTROS_ING', 'tipo': 'INGRESO', 'subtipo': 'REMUNERATIVO',
        'formula': 'HE_100',
        'afecto_essalud': True, 'afecto_afp': True, 'afecto_onp': True,
        'afecto_renta': True, 'afecto_cts': True, 'afecto_gratif': True,
    ...
    'horas_extras_nocturnas': {
        'codigo': 'horas_extras_nocturnas', 'nombre': 'Horas extras nocturnas',
        'descripcion': 'HE realizadas en horario 22:00-06:00. Recargo 35% mínimo sobre RMV nocturna (DS 004-2006-TR). REMUNERATIVO.',
        'categoria': 'OTROS_ING', 'tipo': 'INGRESO', 'subtipo': 'REMUNERATIVO',
        'formula': 'HE_35',
        'afecto_essalud': True, 'afecto_afp': True, 'afecto_onp': True,
        'afecto_renta': True, 'afecto_cts': True, 'afecto_gratif': True,
    ...
    'bonif_feriado_trabajado': {
        'codigo': 'bonif_feriado_trabajado', 'nombre': 'Feriado trabajado (sueldo + 100%)',
        'descripcion': 'Trabajador labora un feriado: recibe sueldo del día + sobretasa 100% (DL 713). REMUNERATIVO.',
        'categoria': 'BONIFICACION', 'tipo': 'INGRESO', 'subtipo': 'REMUNERATIVO',
        'formula': 'MANUAL',
        'afecto_essalud': True, 'afecto_afp': True, 'afecto_onp': True,
        'afecto_renta': True, 'afecto_cts': True, 'afecto_gratif': True,
    ...
    'subsidio_incapacidad': {
        'codigo': 'subsidio_incapacidad', 'nombre': 'Subsidio por incapacidad temporal',
        'descripcion': 'Ley 26790: días 1-20 paga empleador (afecto normal), día 21+ paga ESSALUD (NO REMUNERATIVO). Hasta 11 meses 10 días.',
        'categoria': 'OTROS_ING', 'tipo': 'INGRESO', 'subtipo': 'NO_REMUNERATIVO',
        'formula': 'MANUAL',
        'afecto_essalud': False, 'afecto_afp': False, 'afecto_onp': False,
        'afecto_renta': False, 'afecto_cts': False, 'afecto_gratif': False,
        'afecto_vacaciones': False,
        'codigo_plame': '0904',
    },
    'subsidio_maternidad': {
        'codigo': 'subsidio_maternidad', 'nombre': 'Subsidio por maternidad',
        'descripcion': 'Ley 26790 + Ley 30367: 98 días pre/post-natal pagados por ESSALUD. NO REMUNERATIVO (no descuentos).',
        'categoria': 'OTROS_ING', 'tipo': 'INGRESO', 'subtipo': 'NO_REMUNERATIVO',
        'formula': 'MANUAL',
        'afecto_essalud': False, 'afecto_afp': False, 'afecto_onp': False,
        'afecto_renta': False, 'afecto_cts': False, 'afecto_gratif': False,
    ...
    'subsidio_lactancia': {
        'codigo': 'subsidio_lactancia', 'nombre': 'Subsidio por lactancia',
        'descripcion': '1 hora diaria por el primer año de vida del bebé (Ley 27240). Tiempo pagado como trabajado.',
        'categoria': 'OTROS_ING', 'tipo': 'INGRESO', 'subtipo': 'REMUNERATIVO',
        'formula': 'MANUAL',
        'afecto_essalud': True, 'afecto_afp': True, 'afecto_onp': True,
        'afecto_renta': True, 'afecto_cts': True, 'afecto_gratif': True,
    ...
    'bonif_escolaridad': {
        'codigo': 'bonif_escolaridad', 'nombre': 'Bonificación por escolaridad',
        'descripcion': 'Pago anual (típicamente febrero o marzo) para útiles escolares. Convencional en muchos sectores. REMUNERATIVO.',
        'categoria': 'BONIFICACION', 'tipo': 'INGRESO', 'subtipo': 'REMUNERATIVO',
        'formula': 'MANUAL',
        'afecto_essalud': True, 'afecto_afp': True, 'afecto_onp': True,
        'afecto_renta': True, 'afecto_cts': True, 'afecto_gratif': True,
    ...
    'pension_alimenticia': {
        'codigo': 'pension_alimenticia', 'nombre': 'Pensión alimenticia (orden judicial)',
        'descripcion': 'Descuento por mandato judicial. Hasta 60% rem según Art. 648 CPC. Se calcula sobre rem total menos descuentos legales.',
    ...
    'embargo_civil': {
        'codigo': 'embargo_civil', 'nombre': 'Embargo civil sobre remuneración',
        'descripcion': 'Embargo por orden judicial (deudas civiles). Hasta 30% del exceso sobre 5 URP (Art. 648 CPC).',
        'categoria': 'DESCUENTO', 'tipo': 'DESCUENTO', 'subtipo': 'NO_REMUNERATIVO',
        'formula': 'MANUAL',
        'codigo_plame': '0806',
    },
    'cuota_sindical': {
        'codigo': 'cuota_sindical', 'nombre': 'Cuota sindical',
    ...
    'seguro_vida_ley': {
        ...
        'descripcion': 'Obligatorio a partir del 4° año de servicio. Cubre 16 sueldos por muerte natural, 32 por accidente. Aporte empleador.',
        'categoria': 'APORTE', 'tipo': 'APORTE_EMPLEADOR', 'subtipo': 'NO_REMUNERATIVO',
        'formula': 'PORCENTAJE', 'porcentaje': Decimal('0.53'),  # promedio mercado
        'codigo_plame': '0608',
    },
    'estimulo_educacional': {
        'codigo': 'estimulo_educacional', 'nombre': 'Estímulo educacional / Capacitación',
        'descripcion': 'Reembolso de gastos de capacitación profesional. NO REMUNERATIVO si está bien sustentado (Art. 19 Ley 28518).',
        'categoria': 'OTROS_ING', 'tipo': 'INGRESO', 'subtipo': 'NO_REMUNERATIVO',
        'formula': 'MANUAL',
        'afecto_essalud': False, 'afecto_afp': False, 'afecto_onp': False,
        'afecto_renta': False, 'afecto_cts': False, 'afecto_gratif': False,
