...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.rol_context',
                'core.context_processors.process_bridge_context',
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    # Security audit fix: previene que usuarios usen su DNI/email/nombre como password.
    {
